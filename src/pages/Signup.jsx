...
const Signup = () => {
  ...
  const {axiosInstance,navigate}=useContext(AppContext)
 ...
 */
 ...
 const submitHandler=async(e)=>{
  ...
  return (
    <div>
      <form onSubmit={submitHandler} className="max-w-96 w-full mx-auto  text-center border border-gray-300/60 rounded-2xl px-8 bg-white">
            <h1 className="text-heading text-3xl mt-10 font-medium">Create An Account</h1>
            ...
            <div className="flex items-center w-full mt-10 bg-white border border-gray-300/80 h-12 rounded-full overflow-hidden pl-6 gap-2">
                ...
                <input type="name" name="name" value={formData.name} onChange={onChangeHandler} placeholder="username" className="bg-transparent text-gray-500 placeholder-gray-500 outline-none text-sm w-full h-full" required />                 
            </div>
            ...
            <div className="flex items-center w-full mt-4 bg-white border border-gray-300/80 h-12 rounded-full overflow-hidden pl-6 gap-2">
                <select name="role" onChange={onChangeHandler} value={formData.role} className='bg-transparent text-gray-500 placeholder-gray-500 outline-none text-w-full h-full ' required>
            ...
            <p className="text-gray-500 text-sm mt-3 mb-11">Already have an account?{" "}
