...
const MostPicked = () => {
  ...
  return (
    ...
    <p className='text-paragraph text-sm text-center max-w-lg mx-auto'>Explore our top rated rooms loved by guests for comfort and location.</p>
    
        <div className='flex flex-wrap justify-center mt-12 gap-4 max-w-5xl mx-auto'>
            {
                ...
                /**With motion.div, you can easily animate entry, exit, hover, tap, drag, etc. */
