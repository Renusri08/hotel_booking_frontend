...
const NewsLetter = () => {
  return (
    <div className=" py-12  mx-auto flex md:flex-row flex-col border border-gray-500/30 rounded-lg items-start md:items-center justify-between gap-5 text-sm max-w-5xl bg-white p-8">
    <div className="max-w-md w-full">
        ...
        <div className="flex items-center gap-4 mt-10">
            ...
            <button className="bg-indigo-500 hover:bg-primary transition-all px-6 py-2 rounded text-white font-medium cursor-pointer">Subscribe</button>
        </div>
    </div>
